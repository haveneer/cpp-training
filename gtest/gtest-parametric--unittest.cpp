...
INSTANTIATE_TEST_SUITE_P(Part1, TriangleSuccessTestSuit,
                         testing::Values(std::make_tuple(2, 3, 4), // List of
                                         std::make_tuple(3, 3, 3), // fixed values
...
INSTANTIATE_TEST_SUITE_P(Part2, TriangleFailureTestSuit1,
                         testing::Combine(testing::Values(1),      // Fixed values
                                          testing::Range(1, 8, 3), // Range of values
                                          testing::ValuesIn(other_values) // List
                                          ));

//#region [Custom generator]
